 ...
 *
 * @author Calclavia
 * https://github.com/Universal-Electricity/Universal-Electricity/blob/master/src/universalelectricity/prefab/TranslationHelper.java
 */
    ...
    public static int loadLanguages(String languagePath, String[] languageSupported)
    {
        ...
        for (String language : languageSupported)
        {
            ...
            if (LanguageRegistry.instance().getStringLocalization("children", language) != "")
            {
                ...
                {
                    BurpTechCore.log.severe("Failed to load a child language file.");
                    e.printStackTrace();
                }
            }
